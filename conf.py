...
BLOG_AUTHOR = "yilanxuan"  # (translatable)
BLOG_TITLE = "SUNRISE"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ylx2002.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://macplay.github.io/"
BLOG_EMAIL = "ylxredbag@qq.com"
BLOG_DESCRIPTION = "We all wait for the sunrise."  # (translatable)
